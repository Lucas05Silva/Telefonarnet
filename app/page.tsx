...
export default function Page() {
  ...
  return (
    <main className="overflow-x-hidden bg-[#0A192F] text-white">
      ...
      <section className="relative overflow-hidden bg-radial-[at_50%_0%] from-[#0A192F] to-[#050B14] py-16 md:py-24">
        <svg
          viewBox="0 0 100 90"
          aria-hidden="true"
          className="absolute z-0 pointer-events-none -top-10 -left-10 w-40 rotate-12 opacity-[0.04]"
        ...
        <div className="pointer-events-none absolute inset-0 z-0 bg-[radial-gradient(circle_at_20%_20%,rgba(0,180,216,0.10),transparent_35%),radial-gradient(circle_at_80%_75%,rgba(245,130,32,0.10),transparent_35%)]" />
        <div className="relative z-10">
      ...
      <footer className="relative overflow-hidden bg-radial-[at_50%_0%] from-[#0A192F] to-[#050B14] py-12 border-t border-white/10 px-4 sm:px-6 lg:px-8">
        <svg
          viewBox="0 0 100 90"
          aria-hidden="true"
          className="absolute z-0 pointer-events-none -top-8 -left-8 w-32 rotate-12 opacity-[0.04]"
        >
          <path d="M50 6Q55 6 58 11L93 73Q96 79 91 83Q88 85 83 85H17Q12 85 9 83Q4 79 7 73L42 11Q45 6 50 6Z" className="fill-[#00B4D8]" />
        </svg>
        <svg
          viewBox="0 0 100 90"
          aria-hidden="true"
          className="absolute z-0 pointer-events-none bottom-6 right-8 w-24 -rotate-12 opacity-[0.03]"
        >
          <path d="M50 6Q55 6 58 11L93 73Q96 79 91 83Q88 85 83 85H17Q12 85 9 83Q4 79 7 73L42 11Q45 6 50 6Z" className="fill-[#F58220]" />
        </svg>
        <svg
          viewBox="0 0 100 90"
          aria-hidden="true"
          className="absolute z-0 pointer-events-none top-1/2 left-1/3 w-16 rotate-45 opacity-[0.05]"
        >
          <path d="M50 6Q55 6 58 11L93 73Q96 79 91 83Q88 85 83 85H17Q12 85 9 83Q4 79 7 73L42 11Q45 6 50 6Z" className="fill-[#00B4D8]" />
        </svg>
        <div className="pointer-events-none absolute inset-0 z-0 bg-[radial-gradient(circle_at_20%_20%,rgba(0,180,216,0.10),transparent_35%),radial-gradient(circle_at_80%_75%,rgba(245,130,32,0.10),transparent_35%)]" />
